...
char ssid[] = "DEBUG";     // your network SSID (name)
#else
...
void loop() {
  ...
  for (i = 0; i < maxLED; i++) {
    //OMOTE
    Serial.write(set_g[i * 3 + 1]);
    Serial.write(set_r[i * 3 + 1]);
    Serial.write(set_b[i * 3 + 1]);
    Serial.write(set_g[i * 3 + 0]);
    Serial.write(set_r[i * 3 + 0]);
    Serial.write(set_b[i * 3 + 0]);
    Serial.write(set_g[i * 3 + 2]);
    Serial.write(set_r[i * 3 + 2]);
    Serial.write(set_b[i * 3 + 2]);

    //URA
    Serial.write(set_g[i * 3 + 4]);
    Serial.write(set_r[i * 3 + 4]);
    Serial.write(set_b[i * 3 + 4]);
    Serial.write(set_g[i * 3 + 3]);
    Serial.write(set_r[i * 3 + 3]);
    Serial.write(set_b[i * 3 + 3]);
    Serial.write(set_g[i * 3 + 5]);
    Serial.write(set_r[i * 3 + 5]);
    Serial.write(set_b[i * 3 + 5]);
